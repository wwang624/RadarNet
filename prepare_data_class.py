...
from tools.generate_confmaps import generate_confmaps, generate_confmaps_class
...
save_dir = 'F:\\RadarNet\\dataset_class'
    ...
    for file in anno_files:
        ...
        if not (os.path.exists(os.path.join(radar_data_files, '{:0>6d}.mat'.format(num))) and
            ...
            try:
                ...
                print(e)
                continue
            anno_obj['confmap'].append(generate_confmaps_class(anno_obj['meta_data'][-1], range_grid, angle_grid,
                                                               viz=False))
