...
checkpoint_path = 'F:\\RadarNet\\checkpoints_class\\RadarNet_V2-20230518-163845\\epoch_39_final.pkl'
model_name = 'RadarNet_V2'
cp_path = None
epoch_start = 0
iter_start = 0
...
radarnet.eval()
test_res_dir = os.path.join(os.path.join(test_model_path, 'mlms001_V2'))
...
for iter, data_dict in enumerate(tqdm(train_dataloader)):
    ...
    # data = io.loadmat('E:\\RadarNet\\stand.mat')['data']
    # data = torch.from_numpy(data)
    # data = torch.reshape(data, (1, 1, 8, 8, 128))
...
# ffmpeg -framerate 20 -f image2 -i F:\RadarNet\checkpoints_class_test\pbms002\%d.png -c:v libx265 -vf scale=-1:1024 -pix_fmt yuv420p output_pbms002.mp4
