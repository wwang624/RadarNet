...
from net import vanille_net
import matplotlib.pyplot as plt
from tools.solvedir import create_dir_for_new_model
from RadarNet.datasets.CRDataset import CRDataset
...
from tools.metrics import compute_iou, precision_recall, f1_score
from tools.loss import FocalLoss

# model_v1:
# os.makedirs('E:\\RadarNet\\checkpoints')
train_data_dir = 'F:\\RadarNet\\dataset1\\train'
val_data_dir = 'F:\\RadarNet\\dataset1\\val'
train_model_path = 'F:\\RadarNet\\checkpoints'
model_name = 'RadarNet_V1'
cp_path = None
epoch_start = 0
iter_start = 0
loss_name = 'focal_loss'
model_dir, model_name = create_dir_for_new_model(model_name, train_model_path)
...
for epoch in range(epoch_start, n_epoch):
    ...
    mrec = ave_rec / (iter + 1)
    mf1 = ave_f1 / (iter + 1)
    print('epoch %2d: val_loss: %.4f (%.4f) | miou: %.4f | mprecision: %.4f | mrecall: %.4f | mf1: %.4f' %
          (epoch + 1, val_loss_confmap.item(), val_loss_average, miou, mpre, mrec, mf1))
